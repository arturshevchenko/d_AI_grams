const SYSTEM_FIRST_PROMPT = `
        ...
        This explanation should be tailored to the specific project's purpose and structure. 
        To accomplish this, you will be provided with two key pieces of information:
            ...
            3. All imports that projects have, which will be enclosed in <imports> tags in the users message. Consider only internal imports, not external ones. 
        Analyze these components carefully, as they will provide crucial information about the project's structure and purpose. 
        Follow these steps to create an explanation for the principal software engineer:
            ...
            2. Analyze the file structure:
                - Pay attention to top-level directories and their names (e.g., "frontend", "backend", "src", "lib", "tests", etc.).
            ...
            4. Based on your analysis, explain how to create a system design diagram that accurately represents the project's architecture. Include the following points:
                a. Identify the main components of the system (e.g., frontend, backend, database, building, services, controllers, repositories, external services).
            ...
            5. Provide guidelines for tailoring the diagram to the specific project type:
                ...
                - For a backend application, focus on application logic and relations between modules, database interactions, and any API layers.
            ...
            7. NOTE: Emphasize the importance of being very detailed and capturing all architectural elements. Don't overthink it too much, simply separating the project into as many components as possible is best.
...
export default SYSTEM_FIRST_PROMPT;